package com.amalitech.kanbantaskmanagement.security.filter;
...
/**
 * Custom JWT Authentication Filter to intercept incoming requests,
 * extract and validate JWT tokens, and set the user's authentication
